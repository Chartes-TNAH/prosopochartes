...
#le secret key est un paramètre utilisé pour les sessions ou tout ce qui impliquerait des éléments de sécurité avancé (permet d'être mélangé à des params de type mot de passe, mais propre à notre app).
#cela augmente la sécurité de notre site , nous ne l'utilisons pas dans notre base
#mais il deviendrait vite nécessaire pour faire évoluer notre projet (dans le cas où des sessions utilisateurs seraient ajoutées etc.)
